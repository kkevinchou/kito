...
func TestFillWeightsWithNoChange(t *testing.T) {
	...
	newJointIDs, newWeights := animation.FillWeights(jointIDs, weights, jointWeightsSourceData, maxWeights)
...
func TestNormalizeWeightsHappyPath(t *testing.T) {
	jointWeights := []animation.JointWeight{
		animation.JointWeight{JointID: 0, Weight: 0.55},
		animation.JointWeight{JointID: 0, Weight: 0.25},
		animation.JointWeight{JointID: 0, Weight: 0.20},
	}

	animation.NormalizeWeights(jointWeights)
