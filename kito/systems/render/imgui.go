...
func (renderer *ImguiOpenGL4Renderer) Dispose() {
	renderer.invalidateDeviceObjects()
}

// PreRender clears the framebuffer.
func (renderer *ImguiOpenGL4Renderer) PreRender(clearColor [3]float32) {
	gl.ClearColor(clearColor[0], clearColor[1], clearColor[2], 1.0)
	gl.Clear(gl.COLOR_BUFFER_BIT)
}

// Render translates the ImGui draw data to ImguiOpenGL4Renderer commands.
func (renderer *ImguiOpenGL4Renderer) Render(displaySize [2]float32, framebufferSize [2]float32, drawData imgui.DrawData) {
...
func (renderer *ImguiOpenGL4Renderer) createDeviceObjects() {
	// Backup GL state
	var lastTexture int32
	var lastArrayBuffer int32
	var lastVertexArray int32
...
func (renderer *ImguiOpenGL4Renderer) createFontsTexture() {
	// Build texture atlas
	io := imgui.CurrentIO()
...
func (renderer *ImguiOpenGL4Renderer) invalidateDeviceObjects() {
